...
<div class="body_tree" >
    <div class="mini-layout">
        <div region="west" title="组织机构树" showHeader="true" width="200" minWidth="100" maxWidth="350">
        ...
        <div title="center" region="center">
            <iframe src="/org/orgList" id="mainframe" frameborder="0" name="main"></iframe>
        </div>
    </div>
</div>
<script type="text/javascript" charset="UTF-8" src="${BASE_FRONT}/app/js/common/resize.js"></script>
<script type="text/javascript" charset="UTF-8" src="${BASE_FRONT}/app/js/manage/org/orgtree.js"></script>
</body>
</html>
